...
public class TFValues {
    ...
    public static final ValueProvider<Boolean> TWO_POINTS_DIFFERENCE = new ValueProvider<>(false).addModifiers(new HostValueModifier<>(1, Boolean.class, "two-points-difference"));
